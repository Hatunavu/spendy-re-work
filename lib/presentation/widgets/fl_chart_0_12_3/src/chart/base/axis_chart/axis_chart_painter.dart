...
import 'package:spendy_re_work/presentation/widgets/fl_chart_0_12_3/src/chart/bar_chart/bar_chart_painter.dart';
import 'package:spendy_re_work/presentation/widgets/fl_chart_0_12_3/src/chart/base/base_chart/base_chart_painter.dart';
import 'package:spendy_re_work/presentation/widgets/fl_chart_0_12_3/src/chart/line_chart/line_chart_painter.dart';
...
abstract class AxisChartPainter<D extends AxisChartData>
  ...
  void drawAxisTitles(CanvasWrapper canvasWrapper) {
    ...
    if (leftTitle.showTitle) {
      ...
      final tp = TextPainter(
        ...
        ..layout(minWidth: viewSize.height);
      canvasWrapper
        ..save()
        ..rotate(-math.pi * 0.5)
        ..drawText(
    ...
    if (topTitle.showTitle) {
      ...
      final tp = TextPainter(
          ...
          textDirection: TextDirection.ltr,
          textScaleFactor: textScale)
        ..layout(minWidth: viewSize.width);
  ...
  void _drawBackground(CanvasWrapper canvasWrapper) {
    final viewSize = canvasWrapper.size;
    final usableViewSize = getChartUsableDrawSize(viewSize);
    _backgroundPaint.color = data.backgroundColor ?? AppColor.transparent;
  ...
  void _drawRangeAnnotation(CanvasWrapper canvasWrapper) {
    ...
    if (data.rangeAnnotations.verticalRangeAnnotations.isNotEmpty) {
      for (final annotation in data.rangeAnnotations.verticalRangeAnnotations) {
        ...
        final to = Offset(getPixelX(annotation.x2, chartUsableSize),
