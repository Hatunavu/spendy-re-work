...
class FlAxisTitleData with EquatableMixin {
  ...
  FlAxisTitleData.lerp(FlAxisTitleData? a, FlAxisTitleData? b, double t)
      : show = b!.show,
...
class AxisTitle with EquatableMixin {
  ...
  AxisTitle.lerp(AxisTitle a, AxisTitle b, double t)
...
class FlTitlesData with EquatableMixin {
  ...
  FlTitlesData.lerp(FlTitlesData? a, FlTitlesData? b, double t)
      : show = b!.show,
...
class SideTitles with EquatableMixin {
  ...
  SideTitles.lerp(SideTitles a, SideTitles b, double t)
...
class FlGridData with EquatableMixin {
  ...
  FlGridData.lerp(FlGridData a, FlGridData b, double t)
      : show = b.show,
        ...
        verticalInterval =
            lerpDouble(a.verticalInterval, b.verticalInterval, t),
...
class FlLine with EquatableMixin {
  ...
  /// For example, the array `[5, 10]` would result in dashes 5 pixels long
  /// followed by blank spaces 10 pixels long.
  FlLine({Color? color, double? strokeWidth, this.dashArray})
      : color = color ?? Colors.black,
        strokeWidth = strokeWidth ?? 2;

  /// Lerps a [FlLine] based on [t] value, check [Tween.lerp].
  FlLine.lerp(FlLine a, FlLine b, double t)
...
class RangeAnnotations with EquatableMixin {
  ...
  RangeAnnotations.lerp(RangeAnnotations a, RangeAnnotations b, double t)
...
class HorizontalRangeAnnotation with EquatableMixin {
  ...
  HorizontalRangeAnnotation.lerp(
