    ...
    return MouseRegion(
      onEnter: (e) {
        ...
        final BarTouchResponse? response = _touchHandler?.handleTouch(
            FlPanStart(e.localPosition), chartSize) as BarTouchResponse;
      ...
      onHover: (e) {
        ...
        final BarTouchResponse? response = _touchHandler?.handleTouch(
            FlPanMoveUpdate(e.localPosition), chartSize) as BarTouchResponse;
        if (_canHandleTouch(response!, touchData)) {
          touchData.touchCallback!(response);
        }
      },
      child: GestureDetector(
        onLongPressStart: (d) {
          ...
          final BarTouchResponse? response = _touchHandler?.handleTouch(
              FlLongPressStart(d.localPosition), chartSize) as BarTouchResponse;
          if (_canHandleTouch(response, touchData)) {
            touchData.touchCallback!(response!);
          }
        },
        onLongPressEnd: (d) {
          ...
          final BarTouchResponse? response = _touchHandler?.handleTouch(
              FlLongPressEnd(d.localPosition), chartSize) as BarTouchResponse;
          if (_canHandleTouch(response, touchData)) {
            touchData.touchCallback!(response!);
          }
        },
        ...
        onPanCancel: () {
          ...
          final BarTouchResponse? response = _touchHandler?.handleTouch(
              FlPanEnd(
                  Offset.zero, const Velocity(pixelsPerSecond: Offset.zero)),
              chartSize) as BarTouchResponse;
          if (_canHandleTouch(response, touchData)) {
            touchData.touchCallback!(response!);
          }
        ...
        onPanDown: (DragDownDetails details) {
          ...
          final BarTouchResponse? response = _touchHandler?.handleTouch(
              FlPanStart(details.localPosition), chartSize) as BarTouchResponse;
          if (_canHandleTouch(response, touchData)) {
            touchData.touchCallback!(response!);
          }
        },
