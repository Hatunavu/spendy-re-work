...
import 'package:spendy_re_work/presentation/widgets/fl_chart_0_12_3/src/chart/base/base_chart/base_chart_data.dart';
...
import 'package:spendy_re_work/presentation/widgets/fl_chart_0_12_3/src/extensions/color_extension.dart';
import 'package:spendy_re_work/presentation/widgets/fl_chart_0_12_3/src/utils/lerp.dart';
...
class LineChartBarData with EquatableMixin {
  ...
  LineChartBarData.lerp(LineChartBarData? a, LineChartBarData? b, double t)
      : show = b!.show,
...
class LineChartStepData with EquatableMixin {
  ...
  LineChartStepData.lerp(LineChartStepData a, LineChartStepData b, double t)
...
class BarAreaData with EquatableMixin {
  ...
  BarAreaData.lerp(BarAreaData a, BarAreaData b, double t)
      : show = b.show,
        gradientFrom = Offset.lerp(a.gradientFrom, b.gradientFrom, t)!,
        gradientTo = Offset.lerp(a.gradientTo, b.gradientTo, t)!,
...
class BetweenBarsData with EquatableMixin {
  ...
  BetweenBarsData.lerp(BetweenBarsData? a, BetweenBarsData? b, double t)
...
class BarAreaSpotsLine with EquatableMixin {
  ...
  BarAreaSpotsLine.lerp(BarAreaSpotsLine a, BarAreaSpotsLine b, double t)
      : show = b.show,
...
class FlDotData with EquatableMixin {
  ...
  FlDotData.lerp(FlDotData a, FlDotData b, double t)
      : show = b.show,
...
class HorizontalLine extends FlLine with EquatableMixin {
  ...
  factory HorizontalLine.lerp(HorizontalLine? a, HorizontalLine? b, double t) {
...
class VerticalLine extends FlLine with EquatableMixin {
  ...
  factory VerticalLine.lerp(VerticalLine? a, VerticalLine? b, double t) {
    return VerticalLine(
...
class HorizontalLineLabel extends FlLineLabel with EquatableMixin {
  ...
  factory HorizontalLineLabel.lerp(
...
class VerticalLineLabel extends FlLineLabel with EquatableMixin {
  ...
  factory VerticalLineLabel.lerp(
...
class ExtraLinesData with EquatableMixin {
  ...
  factory ExtraLinesData.lerp(ExtraLinesData a, ExtraLinesData b, double t) {
...
class ShowingTooltipIndicators with EquatableMixin {
  ...
  ShowingTooltipIndicators(this.lineIndex, this.showingSpots);
...
class LineChartDataTween extends Tween<LineChartData> {
  ...
  @override
  LineChartData lerp(double t) => begin!.lerp(begin!, end!, t) as LineChartData;
}
