...
class LinearPercentIndicator extends StatefulWidget {
  ...
  LinearPercentIndicator({
    ...
    assert(curve != null, 'curve not null');
...
class _LinearPercentIndicatorState extends State<LinearPercentIndicator>
  ...
  late double _containerWidth = 0.0;
  late double _containerHeight = 0.0;
  late double _indicatorWidth = 0.0;
  late double _indicatorHeight = 0.0;
