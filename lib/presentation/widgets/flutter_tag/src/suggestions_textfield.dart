...
class _SuggestionsTextFieldState extends State<SuggestionsTextField> {
  ...
  Widget build(BuildContext context) {
    _helperText = widget.tagsTextField.helperText;
  ...
  InputDecoration get _initialInputDecoration {
    ...
    return input.copyWith(
        ...
        hintText: widget.tagsTextField.hintText,
  ...
  void _checkOnChanged(String str) {
    if (_suggestions != null) {
      ...
      setState(() {
        if (str.isEmpty || !_constraintSuggestion! || _matches!.isNotEmpty) {
          _helperCheck = true;
        } else {
          _helperCheck = false;
        }
