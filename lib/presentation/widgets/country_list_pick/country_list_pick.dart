...
import 'package:spendy_re_work/presentation/widgets/country_list_pick/selection_list.dart';
import 'package:spendy_re_work/presentation/widgets/country_list_pick/support/code_countries_en.dart';
import 'package:spendy_re_work/presentation/widgets/country_list_pick/support/code_countrys.dart';
...
class CountryListPick extends StatefulWidget {
  ...
  _CountryListPickState createState() {
    final List<Map> jsonList =
        theme?.showEnglishName ?? true ? countriesEnglish : codes;

    final List elements = jsonList
        .map((s) => CountryCode(
              name: s['name'],
              code: s['code'],
...
class _CountryListPickState extends State<CountryListPick> {
  ...
  Future<void> _awaitFromSelectScreen(BuildContext context,
