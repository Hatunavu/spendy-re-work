...
class TopSnackBar<T extends Object> extends StatefulWidget {
  ...
  late TopSnackBarRoute? _topSnackBarRoute;
  TopSnackBar({
    Key? key,
    this.context,
    this.title,
...
class _TopSnackBarState<K extends Object> extends State<TopSnackBar>
  ...
  late TopSnackBarStatus currentStatus;
  ...
  Widget _buildTitleText() {
    return Text(
      ...
      style: ThemeText.getDefaultTextTheme().snackbarTextStyle,
    );
  }
