...
class DatePickerWidget extends StatefulWidget {
  DatePickerWidget({
    ...
    assert(
        minTime.compareTo(maxTime) < 0, 'min time must be less than max time');
  }
  ...
  final dynamic onMonthChangeStartWithFirstDate;

  @override
  State<StatefulWidget> createState() =>
      _DatePickerWidgetState(minDateTime, maxDateTime, initialDateTime);
}
