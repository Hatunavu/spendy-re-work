...
class DataConnectionChecker {
  ...
  static const Duration defaiultInterval = Duration(seconds: 10);
  ...
  ///
  /// Defaults to [defaiultInterval] (10 seconds).
  Duration checkInterval = defaiultInterval;
